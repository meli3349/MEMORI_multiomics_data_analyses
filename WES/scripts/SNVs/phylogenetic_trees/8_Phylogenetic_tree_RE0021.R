...
patient_name <- "MEMORI_RE0021"

   
sample_A1 <- "MEMORI_RE0021A_T2_C1_D1"      
sample_B1 <- "MEMORI_RE0021B_T1_C1_D1"  
sample_C1 <- "MEMORI_RE0021C_T1_C1_D1"  
...
plotBS(DNAtreeMP,DNABStrees,type.tree='phylogram',bs.adj=c(1.3,1.3),label.offset=15,p=0,type="phylogram", edge.color= c('#E64B35FF', '#568ebd', '#0A9086', 'grey', "#7E6148FF", "#7E6148FF"), edge.width=3,font=2,cex=1.5,tip.color=c('#E64B35FF', '#0A9086', '#568ebd', "#7E6148FF"))
add.scale.bar(750,01, lwd=3,font=2);mtext(paste0('HI: ',hi),side=3,font=2,cex=1.25,ask=T);show.node.label = T;

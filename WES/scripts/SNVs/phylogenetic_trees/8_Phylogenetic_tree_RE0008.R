...
patient_name <- "MEMORI_RE0008"

sample_A1 <- "MEMORI_RE0008A_T1_B1_D1"    
sample_B1 <- "MEMORI_RE0008C_T1_C1_D1" 
sample_C1 <- "MEMORI_RE0008C_T3_C1_D1"
...
plotBS(DNAtreeMP,DNABStrees,type.tree='phylogram',bs.adj=c(1.3,1.3),label.offset=15,p=0,type="phylogram", edge.color= c('#E64B35FF', '#568ebd', 'grey', '#568ebd', "#7E6148FF", "#7E6148FF"), edge.width=3,font=2,cex=1.5,tip.color=c('#E64B35FF', '#568ebd', '#7E6148FF', '#568ebd'))

...
patient_name <- "MEMORI_RE0006"

     
sample_A1 <- "MEMORI_RE0006B_T1_B1_D1"       
sample_B1 <- "MEMORI_RE0006C_T2_M1_D1" 
sample_C1 <- "MEMORI_RE0006C_T3_C1_D1"
...
# No pretreatment sample therefore not included in branch SNVs analysis
...
plotBS(DNAtreeMP,DNABStrees,type.tree='phylogram',bs.adj=c(1.3,1.3),label.offset=15,p=0,type="phylogram", edge.color= c('#568ebd', '#568ebd', 'grey', '#0A9086', "#7E6148FF", "#7E6148FF"), edge.width=3,font=2,cex=1.5,tip.color=c('#0A9086', '#568ebd', '#568ebd', "#7E6148FF"))

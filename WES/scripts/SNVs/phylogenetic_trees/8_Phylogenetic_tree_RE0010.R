...
patient_name <- "MEMORI_RE0010"

sample_A1 <- "MEMORI_RE0010A_T1_C1_D1" 
sample_A2 <-"MEMORI_RE0010A_T2_C1_D1" 
sample_A3 <-"MEMORI_RE0010A_T4_C1_D1" 

sample_B1 <- "MEMORI_RE0010B_T1_B1_D1"
sample_B2 <-"MEMORI_RE0010B_T2_C1_D1"
sample_B3 <-"MEMORI_RE0010B_T3_C1_D1"  

sample_C1 <- "MEMORI_RE0010C_T1_C1_D1"  
...
label_A3 <- paste0(sapply(sample_A3, function(x) substr(x,14,14)), "_", sapply(sample_A3, function(x) substr(x,17,17)))
...
neo_snv_3 <- read.table(paste0("~/analysis/WES/neoantigens/filtering_steps/tables/neoSNV_tables/", sample_A3, ".weakly_filtered_neoSNVs"), header = T, stringsAsFactors = F, sep="\t")

neo_snv_4 <- read.table(paste0("~/analysis/WES/neoantigens/filtering_steps/tables/neoSNV_tables/", sample_B1, ".weakly_filtered_neoSNVs"), header = T, stringsAsFactors = F, sep="\t")
neo_snv_5 <- read.table(paste0("~/analysis/WES/neoantigens/filtering_steps/tables/neoSNV_tables/", sample_B2, ".weakly_filtered_neoSNVs"), header = T, stringsAsFactors = F, sep="\t")
neo_snv_6 <- read.table(paste0("~/analysis/WES/neoantigens/filtering_steps/tables/neoSNV_tables/", sample_B3, ".weakly_filtered_neoSNVs"), header = T, stringsAsFactors = F, sep="\t")
neo_snv_7 <- read.table(paste0("~/analysis/WES/neoantigens/filtering_steps/tables/neoSNV_tables/", sample_C1, ".weakly_filtered_neoSNVs"), header = T, stringsAsFactors = F, sep="\t")

final_Neo_SNV <- data.frame(rbind(neo_snv_1, neo_snv_2, neo_snv_3, neo_snv_4, neo_snv_5,  neo_snv_6,  neo_snv_7))
...
shared_all <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A1] == 1 & DNA_bin_driver_annotated[,label_A2] == 1 & DNA_bin_driver_annotated[,label_A3] == 1 & DNA_bin_driver_annotated[,label_B1] == 1 & DNA_bin_driver_annotated[,label_B2] == 1 & DNA_bin_driver_annotated[,label_B3] == 1 & DNA_bin_driver_annotated[,label_C1] == 1), ]
...
present_A3  <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A3] == 1), ]

not_present_A1_A2_A3 <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A1] == 0 & DNA_bin_driver_annotated[,label_A2] == 0 & DNA_bin_driver_annotated[,label_A3] == 0), ] 

shared_all_not_B2 <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A1] == 1 & DNA_bin_driver_annotated[,label_A2] == 1 & DNA_bin_driver_annotated[,label_A3] == 1 & DNA_bin_driver_annotated[,label_B1] == 1 & DNA_bin_driver_annotated[,label_B2] == 0 & DNA_bin_driver_annotated[,label_B3] == 1 & DNA_bin_driver_annotated[,label_C1] == 1), ]

shared_B3_A1 <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A1] == 1 & DNA_bin_driver_annotated[,label_A2] == 0 & DNA_bin_driver_annotated[,label_A3] == 0 & DNA_bin_driver_annotated[,label_B1] == 0 & DNA_bin_driver_annotated[,label_B2] == 0 & DNA_bin_driver_annotated[,label_B3] == 1 & DNA_bin_driver_annotated[,label_C1] == 0), ]

shared_A2_B1_A4_C1 <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A1] == 0 & DNA_bin_driver_annotated[,label_A2] == 1 & DNA_bin_driver_annotated[,label_A3] == 1 & DNA_bin_driver_annotated[,label_B1] == 1 & DNA_bin_driver_annotated[,label_B2] == 0 & DNA_bin_driver_annotated[,label_B3] == 0 & DNA_bin_driver_annotated[,label_C1] == 1), ]

shared_A2_B1 <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A1] == 0 & DNA_bin_driver_annotated[,label_A2] == 1 & DNA_bin_driver_annotated[,label_A3] == 0 & DNA_bin_driver_annotated[,label_B1] == 1 & DNA_bin_driver_annotated[,label_B2] == 0 & DNA_bin_driver_annotated[,label_B3] == 0 & DNA_bin_driver_annotated[,label_C1] == 0), ]

shared_A4_C1 <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A1] == 0 & DNA_bin_driver_annotated[,label_A2] == 0 & DNA_bin_driver_annotated[,label_A3] == 1 & DNA_bin_driver_annotated[,label_B1] == 0 & DNA_bin_driver_annotated[,label_B2] == 0 & DNA_bin_driver_annotated[,label_B3] == 0 & DNA_bin_driver_annotated[,label_C1] == 1), ]

private_A1 <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A1] == 1 & DNA_bin_driver_annotated[,label_A2] == 0 & DNA_bin_driver_annotated[,label_A3] == 0 & DNA_bin_driver_annotated[,label_B1] == 0 & DNA_bin_driver_annotated[,label_B2] == 0 & DNA_bin_driver_annotated[,label_B3] == 0 & DNA_bin_driver_annotated[,label_C1] == 0), ]
private_A2 <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A1] == 0 & DNA_bin_driver_annotated[,label_A2] == 1 & DNA_bin_driver_annotated[,label_A3] == 0 & DNA_bin_driver_annotated[,label_B1] == 0 & DNA_bin_driver_annotated[,label_B2] == 0 & DNA_bin_driver_annotated[,label_B3] == 0 & DNA_bin_driver_annotated[,label_C1] == 0), ]
private_A4 <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A1] == 0 & DNA_bin_driver_annotated[,label_A2] == 0 & DNA_bin_driver_annotated[,label_A3] == 1 & DNA_bin_driver_annotated[,label_B1] == 0 & DNA_bin_driver_annotated[,label_B2] == 0 & DNA_bin_driver_annotated[,label_B3] == 0 & DNA_bin_driver_annotated[,label_C1] == 0), ]

private_B1 <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A1] == 0 & DNA_bin_driver_annotated[,label_A2] == 0 & DNA_bin_driver_annotated[,label_A3] == 0 & DNA_bin_driver_annotated[,label_B1] == 1 & DNA_bin_driver_annotated[,label_B2] == 0 & DNA_bin_driver_annotated[,label_B3] == 0 & DNA_bin_driver_annotated[,label_C1] == 0), ]
private_B2 <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A1] == 0 & DNA_bin_driver_annotated[,label_A2] == 0 & DNA_bin_driver_annotated[,label_A3] == 0 & DNA_bin_driver_annotated[,label_B1] == 0 & DNA_bin_driver_annotated[,label_B2] == 1 & DNA_bin_driver_annotated[,label_B3] == 0 & DNA_bin_driver_annotated[,label_C1] == 0), ]
private_B3 <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A1] == 0 & DNA_bin_driver_annotated[,label_A2] == 0 & DNA_bin_driver_annotated[,label_A3] == 0 & DNA_bin_driver_annotated[,label_B1] == 0 & DNA_bin_driver_annotated[,label_B2] == 0 & DNA_bin_driver_annotated[,label_B3] == 1 & DNA_bin_driver_annotated[,label_C1] == 0), ]

private_C1 <- DNA_bin_driver_annotated[which(DNA_bin_driver_annotated[,label_A1] == 0 & DNA_bin_driver_annotated[,label_A2] == 0 & DNA_bin_driver_annotated[,label_A3] == 0 & DNA_bin_driver_annotated[,label_B1] == 0 & DNA_bin_driver_annotated[,label_B2] == 0 & DNA_bin_driver_annotated[,label_B3] == 0 & DNA_bin_driver_annotated[,label_C1] == 1), ]

View(shared_all); View(shared_all_not_B2); View(shared_B3_A1); View(shared_A2_B1_A4_C1); View(shared_A2_B1); View(shared_A4_C1);
View(private_A1); View(private_A2); View(private_A4); View(private_B1); View(private_B2); View(private_B3); View(private_C1);

# Export SNVs from tree branches according to received therapy 
pre_treatment <- rbind(present_A1, present_A2, present_A3)
...
chemo_induced <- not_present_A1_A2_A3
...
plotBS(DNAtreeMP,DNABStrees,type.tree='phylogram',bs.adj=c(1.3,1.3),label.offset=15,p=0,type="phylogram", edge.color= c('#E64B35FF', '#568ebd', '#E64B35FF', '#0A9086', 'grey', 'grey', '#E64B35FF', '#0A9086', 'grey', 'grey', 'grey', '#0A9086', "#7E6148FF", "#7E6148FF"), edge.width=3,font=2,cex=1.5,tip.color=c('#E64B35FF', '#E64B35FF', '#E64B35FF', '#0A9086', '#0A9086', '#0A9086', '#568ebd', "#7E6148FF"))

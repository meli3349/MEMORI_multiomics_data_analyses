...
patient_name <- "MEMORI_NE0005"
sample_A1 <- "MEMORI_NE0005A_T2_B1_D1"   
sample_B1 <- "MEMORI_NE0005B_T2_B1_D1"
sample_C1 <- "MEMORI_NE0005C_T2_C1_D1"

samnames <- c("MEMORI_NE0005A_T2_B1_D1", "MEMORI_NE0005B_T2_B1_D1", "MEMORI_NE0005C_T2_C1_D1")
...
plotBS(DNAtreeMP,DNABStrees,type.tree='phylogram',bs.adj=c(1.3,1.3),label.offset=10,p=0,type="phylogram", edge.color= c('#E64B35FF', '#0A9086', '#568ebd', "grey", "#7E6148FF", "#7E6148FF"), edge.width=3,font=2,cex=1.5,tip.color=c('#E64B35FF', '#0A9086', '#568ebd', "#7E6148FF"))
